...
-- (5, 'Mercury', 'Ternopil', NULL, 34), street не може бути NULL
(5, 'Mercury', 'Ternopil', 'Mazepy', 34),
...
(38,'ViktorKovalov','Viktor','Kovalov','Seller','2002-12-19',3,11,3500,175), -- position  не може бути NULL (виправила)
...
USE company;
INSERT INTO customer (customer_id,first_name,last_name,gender,birth_date,phone_number,email,discount) VALUES -- замість 'genger' має бути 'gender'
...
(56, 'Leonid','Musiyenko','M','1991-06-06','380-63-855-58-20','LeonidMusiyenko@mail.com',25), -- номер телефону має бути без дефісу (-)
...
('20220912081145',20,49,2, '2022-09-12 08:11:45',4), -- employee_id не може бути NULL
...
-- ('20230922111119',43,43,1, '2023-09-23 11:56:01',3), неправильно прописано invoice_id
